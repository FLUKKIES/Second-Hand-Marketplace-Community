...
export const SocketProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    useEffect(() => {
        ...
        // If API URL is relative (e.g. "/api"), use window.location (undefined)
        // to avoid connecting to a non-existent namespace like "/api"
        const baseUrl = apiUrl?.startsWith("/") ? undefined : apiUrl;
