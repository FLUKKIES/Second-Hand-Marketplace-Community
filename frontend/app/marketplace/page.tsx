          ...
          <div className="md:col-span-9 lg:col-span-9 flex flex-col gap-6 h-full overflow-y-auto pb-20 scrollbar-hide">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-sm border border-gray-100 relative overflow-hidden flex flex-col justify-center min-h-[200px]">
              ...
              <div className="relative z-10 max-w-3xl">
                ...
                <p className="text-gray-500 text-lg leading-relaxed">
                  Explore diverse communities and find products tailored to your
                  interests. Joins groups, buy and sell items, and connect with
                  people like you.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {categories.map((category) => (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-indigo-50 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform text-indigo-600 overflow-hidden">
                    {category.imageUrl ? (
                      <img
                  ...
                  <p className="text-sm text-gray-500 line-clamp-2 mb-4">
                    {category.description ||
                      `Browse groups and items in ${category.name}`}
                  </p>
            ...
            {loading && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div
                    key={i}
                    className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 h-64 animate-pulse"
                  >
